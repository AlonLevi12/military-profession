...
// ---------------------------------------------------------------------------
// ניהול סיכונים — additional risk rows (built like the first row).
// Each row reuses the same 11 fields; only the answers/distractors differ.
// Shared field metadata keeps the build steps consistent across rows.
// ---------------------------------------------------------------------------
interface RiskFieldData {
  correct: string;
  correctFb: string;
  d1: string;
  d1tag: string;
...
type RiskFieldBase = (typeof riskRowFieldOrder)[number];

const riskFieldMeta: Record<
  RiskFieldBase,
  { title: string; purpose: string; whatBelongs: string; commonMistakes: string }
> = {
  stage: {
    title: "שלב במשימה",
    purpose: "למקם את גורם הסיכון בשלב המבצעי שבו הוא רלוונטי.",
    whatBelongs: "השלב במשימה שבו מתקיים גורם הסיכון.",
  ...
  "risk-statement": {
    ...
    whatBelongs: "ניסוח של גורם, אירוע אפשרי ותוצאה.",
    commonMistakes: "שם קצר של גורם בלי תרחיש ותוצאה.",
  },
  severity: {
    title: "חומרה",
  ...
  "owner-deadline": {
    ...
    whatBelongs: "בעל תפקיד, פעולה, מועד ודיווח.",
    commonMistakes: "„כולם” כאחראי או היעדר מועד.",
  },
  residual: {
    title: "סיכון שיורי",
    purpose: "להעריך מחדש את הסיכון לאחר המענה.",
    whatBelongs: "ערך מעודכן מהמטריצה בהתאם להשפעת הפעולה.",
...
function buildRiskRow(
  ...
  startOrder: number,
  firstPrereq: string,
  data: Record<RiskFieldBase, RiskFieldData>,
): DocumentSection[] {
  let prereq = firstPrereq;
  return riskRowFieldOrder.map((base, index) => {
    const id = `${prefix}-${base}`;
    const meta = riskFieldMeta[base];
    const d = data[base];
    const built = section({
      id,
      title: meta.title,
      purpose: meta.purpose,
      whatBelongs: meta.whatBelongs,
      commonMistakes: meta.commonMistakes,
      order: startOrder + index,
      prerequisiteIds: [prereq],
      correctOptionIds: [`${id}-correct`],
      options: [
        option(`${id}-correct`, d.correct, "נכון", d.correctFb, ""),
        option(`${id}-d1`, d.d1, d.d1tag, "", d.d1fb),
        option(`${id}-d2`, d.d2, d.d2tag, "", d.d2fb),
      ],
    });
    prereq = id;
    return built;
...
const riskRow2Data: Record<RiskFieldBase, RiskFieldData> = {
  stage: {
    correct: "במהלך הפעילות בתחנות",
    correctFb: "עומס החום מתקיים בשעות הפעילות בתחנות הפתוחות.",
    d1: "לפני יציאה",
    d1tag: "שלב לא מתאים",
    d1fb: "עומס החום מתקיים בשעות הפעילות, לא בשלב ההכנה.",
    d2: "בסיום היום ובפיזור",
    d2tag: "שלב לא מתאים",
    d2fb: "החום משמעותי בשעות הצהריים, לא בפיזור.",
  },
  m5: {
    correct: "Medium – סביבה: חשיפה ממושכת לשמש בתחנות הפתוחות.",
    correctFb: "מקור הסיכון הוא תנאי הסביבה — חום וחשיפה לשמש.",
    d1: "Man – אדם: חשיפה ממושכת לשמש בתחנות הפתוחות.",
    d1tag: "תחום לא מתאים",
    d1fb: "המקור הוא תנאי הסביבה ולא כשל אנושי.",
    d2: "Machine – ציוד ואמצעים: חשיפה ממושכת לשמש.",
    d2tag: "תחום לא מתאים",
    d2fb: "אין כאן כשל בציוד; מקור הסיכון סביבתי.",
  },
  hazard: {
    correct: "עומס חום בשעות הצהריים בתחנות הפתוחות",
    correctFb: "זהו מצב קיים בעל פוטנציאל לנזק.",
    d1: "משתתף יקרוס ממכת חום",
    d1tag: "זהו סיכון",
    d1fb: "זו תוצאה אפשרית ולכן שייכת לסיכון, לא לסכנה.",
    d2: "חום",
    d2tag: "עמום",
    d2fb: "המילה לבדה אינה מגדירה את המצב המסוכן.",
  },
  "risk-statement": {
    correct:
      "בשל חשיפה ממושכת לשמש עלולה להתרחש מכת חום ולפגוע במשתתף",
    correctFb: "הניסוח כולל גורם, אירוע אפשרי ותוצאה.",
    d1: "עומס חום בתחנות",
    d1tag: "זו סכנה",
    d1fb: "זהו מצב קיים; חסר תרחיש התממשות ותוצאה.",
    d2: "חם בחוץ",
    d2tag: "אינו תרחיש",
    d2fb: "אמירה כללית שאינה מסבירה מה עלול לקרות ולמה.",
  },
  severity: {
    correct: "B — בינוני: מכת חום עלולה לפגוע במשתתף ולחייב פינוי.",
    correctFb: "החומרה מתייחסת לתוצאה האפשרית.",
    d1: "C — קל: אי־נוחות קלה בלבד.",
    d1tag: "נמוכה מדי",
    d1fb: "מכת חום עלולה לחייב פינוי ולכן דרגה קלה אינה מתאימה.",
    d2: "A — חמור בכל מקרה, כי חם.",
    d2tag: "ללא הנמקה",
    d2fb: "אין לקבוע חומרה לפי תחושה; יש להתייחס לתוצאה הסבירה.",
  },
  likelihood: {
    correct:
      "בינונית: בשעות הצהריים החשיפה לשמש ממשית והסבירות לעומס עולה.",
    correctFb: "ההערכה מבוססת על התנאים הקיימים.",
    d1: "זניחה: בדרך כלל לא חם מדי.",
    d1tag: "נמוכה מדי",
    d1fb: "ההערכה מתעלמת מהחשיפה הממשית בשעות הצהריים.",
    d2: "גבוהה: בהכרח תתרחש מכת חום.",
    d2tag: "גבוהה מדי",
    d2fb: "חשיפה אינה מבטיחה פגיעה; יש להעריך לפי התנאים.",
  },
  "initial-level": {
    correct: "8 — גבוה (בינוני B × סבירות בינונית).",
    correctFb: "במטריצה, בינוני B מול סבירות בינונית נותן 8 — סיכון גבוה.",
    d1: "4 — נמוך.",
    d1tag: "ערך שגוי",
    d1fb: "4 מתאים לקל C מול סבירות בינונית, לא לדרגות שנבחרו.",
    d2: "2 — נמוך.",
    d2tag: "ערך שגוי",
    d2fb: "2 מתאים לקל C מול סבירות נמוכה; יש לקרוא מהמשבצת הנכונה.",
  },
  mitigation: {
    correct:
      "פעילות מתקנת: הצללה בתחנות, הפסקות שתייה כל 45 דקות ומעקב חום.",
    correctFb: "הפעולה מפחיתה את החשיפה ואת הסבירות לפגיעה.",
    d1: "פעילות מתקנת: להזכיר למשתתפים לשתות.",
    d1tag: "חלש מדי",
    d1fb: "תזכורת כללית אינה מפחיתה את החשיפה לשמש.",
    d2: "פעילות מתקנת: לבטל את כל יום האימון.",
    d2tag: "אינו מידתי",
    d2fb: "לפני ביטול יש לבחון מענה שמטפל בגורם, כגון הצללה ושתייה.",
  },
  "owner-deadline": {
    correct:
      "אחראי תחנה: יוודא הצללה ושתייה וידווח למפקד הפעילות בכל מעבר.",
    correctFb: "מוגדרים אחראי, פעולה ודיווח.",
    d1: "כולם: ידאגו לשתות.",
    d1tag: "אחריות עמומה",
    d1fb: "כשכולם אחראים אין מול מי לבצע בקרה.",
    d2: "אחראי תחנה: יטפל בנושא החום.",
    d2tag: "חסר מועד",
    d2fb: "לא הוגדרו פעולה מדויקת, מועד ודיווח.",
  },
  residual: {
    correct:
      "6 — בינוני (בינוני B × סבירות נמוכה): לאחר הצללה ושתייה הסבירות יורדת לנמוכה.",
    correctFb: "המענה מפחית את הסבירות; החומרה נשארת משמעותית.",
    d1: "8 — גבוה: אין צורך לשנות את ההערכה.",
    d1tag: "לא הוערך מחדש",
    d1fb: "סיכון שיורי מחייב הערכה מחדש לאחר המענה.",
    d2: "0 — אין עוד סיכון.",
    d2tag: "ביטול מלאכותי",
    d2fb: "מענה מפחית סיכון אך אינו מבטל אותו לחלוטין.",
  },
  monitoring: {
    correct:
      "בקרה ועדכון: מפקד הפעילות יבצע בקרת שתייה בכל מעבר ויעדכן בעליית טמפרטורה.",
    correctFb: "מוגדרים נקודת בקרה ותנאי לעדכון ההערכה.",
    d1: "בקרה ועדכון: להניח שכל המשתתפים שותים.",
    d1tag: "חסרה בקרה",
    d1fb: "הנחה אינה בקרה; נדרש לוודא בפועל.",
    d2: "בקרה ועדכון: לבדוק בסוף היום אם מישהו נפגע.",
    d2tag: "מאוחר מדי",
    d2fb: "הבקרה צריכה לאפשר תגובה תוך כדי, לא רק בסיום.",
  },
};

const riskRow3Data: Record<RiskFieldBase, RiskFieldData> = {
  stage: {
    correct: "במעבר בין תחנות",
    correctFb: "חוסר הציוד מתגלה במעבר ולפני פתיחת התחנה.",
    d1: "לפני יציאה",
    d1tag: "שלב לא מתאים",
    d1fb: "הסיכון לציוד התחנה רלוונטי בעיקר במעבר ובפתיחה.",
    d2: "בסיום היום",
    d2tag: "שלב לא מתאים",
    d2fb: "מאוחר מדי; הסיכון רלוונטי בזמן הפעילות.",
  },
  m5: {
    correct: "Machine – ציוד ואמצעים: ציוד תחנה חסר או לא תקין לפני פתיחה.",
    correctFb: "מקור הסיכון הוא הציוד עצמו.",
    d1: "Management – פיקוד ושליטה: ציוד תחנה חסר.",
    d1tag: "תחום לא מתאים",
    d1fb: "ייתכן היבט ניהולי, אך מקור הסיכון הוא האמצעי.",
    d2: "Medium – סביבה: ציוד תחנה חסר.",
    d2tag: "תחום לא מתאים",
    d2fb: "Medium עוסק בתנאים חיצוניים, לא בציוד.",
  },
  hazard: {
    correct: "ציוד תחנה חסר או לא תקין לפני פתיחה",
    correctFb: "מצב קיים בעל פוטנציאל לעיכוב.",
    d1: "התחנה תיפתח באיחור",
    d1tag: "זהו סיכון",
    d1fb: "זו תוצאה אפשרית ולכן שייכת לסיכון.",
    d2: "ציוד",
    d2tag: "עמום",
    d2fb: "המילה לבדה אינה מגדירה את המצב המסוכן.",
  },
  "risk-statement": {
    correct:
      "בשל ציוד חסר עלול להיווצר עיכוב בפתיחת התחנה ופגיעה ברצף הפעילות",
    correctFb: "כולל גורם, אירוע אפשרי ותוצאה.",
    d1: "ציוד חסר בתחנה",
    d1tag: "זו סכנה",
    d1fb: "מצב קיים; חסר תרחיש ותוצאה.",
    d2: "יהיו בעיות בתחנה",
    d2tag: "עמום",
    d2fb: "אמירה כללית ללא תרחיש ותוצאה.",
  },
  severity: {
    correct: "C — קל: עיכוב מוגבל ברצף הפעילות הניתן להשלמה.",
    correctFb: "התוצאה מוגבלת וניתנת להשלמה.",
    d1: "A — חמור: כל חוסר ציוד עוצר את היום.",
    d1tag: "מוגזם",
    d1fb: "חוסר בפריט בודד אינו עוצר בהכרח את כל היום.",
    d2: "C — קל בלי קשר לתרחיש.",
    d2tag: "ללא הנמקה",
    d2fb: "יש לנמק את הדרגה לפי התוצאה בתרחיש.",
  },
  likelihood: {
    correct: "בינונית: ייתכן חוסר ציוד אם לא בוצעה בדיקה מקדימה.",
    correctFb: "מבוסס על התנאים הקיימים.",
    d1: "זניחה: הציוד תמיד תקין.",
    d1tag: "נמוכה מדי",
    d1fb: "ללא בדיקה מקדימה קיימת אי־ודאות ממשית.",
    d2: "גבוהה: בהכרח יחסר ציוד.",
    d2tag: "גבוהה מדי",
    d2fb: "היעדר בדיקה אינו מבטיח חוסר.",
  },
  "initial-level": {
    correct: "4 — נמוך (קל C × סבירות בינונית).",
    correctFb: "במטריצה, קל C מול סבירות בינונית נותן 4 — סיכון נמוך.",
    d1: "8 — גבוה.",
    d1tag: "ערך שגוי",
    d1fb: "8 מתאים לבינוני B מול סבירות בינונית.",
    d2: "9 — גבוה.",
    d2tag: "ערך שגוי",
    d2fb: "9 מתאים לחמור A מול סבירות בינונית.",
  },
  mitigation: {
    correct:
      "פעילות מתקנת: בדיקת ציוד לכל תחנה לפני הפתיחה והעמדת ציוד חלופי.",
    correctFb: "מטפל בגורם ומפחית את הסבירות לעיכוב.",
    d1: "פעילות מתקנת: לקוות שהציוד תקין.",
    d1tag: "חלש מדי",
    d1fb: "תקווה אינה מענה; נדרשת בדיקה.",
    d2: "פעילות מתקנת: לבטל את התחנה.",
    d2tag: "אינו מידתי",
    d2fb: "לפני ביטול יש לבחון בדיקה וחלופה.",
  },
  "owner-deadline": {
    correct:
      "אחראי לוגיסטיקה: יבדוק ציוד עד 07:15 וידווח מוכנות למפקד הפעילות.",
    correctFb: "מוגדרים אחראי, מועד ודיווח.",
    d1: "כולם: יביאו ציוד.",
    d1tag: "אחריות עמומה",
    d1fb: "אין בעל תפקיד מוגדר לבקרה.",
    d2: "אחראי לוגיסטיקה: יבדוק לפני הפעילות.",
    d2tag: "חסר מועד",
    d2fb: "„לפני הפעילות” אינו מועד שמאפשר תגובה.",
  },
  residual: {
    correct:
      "0 — נמוך (קל C × סבירות זניחה): לאחר בדיקה וחלופה הסבירות יורדת לזניחה.",
    correctFb: "המענה מפחית את הסבירות כמעט לאפס.",
    d1: "4 — נמוך: אין שינוי לאחר המענה.",
    d1tag: "לא הוערך מחדש",
    d1fb: "יש להעריך מחדש את הסבירות לאחר הבדיקה.",
    d2: "8 — גבוה: החמרה ללא בסיס.",
    d2tag: "ערך שגוי",
    d2fb: "אין בסיס להחמרה לאחר מתן מענה.",
  },
  monitoring: {
    correct:
      "בקרה ועדכון: דיווח מוכנות ציוד לפני כל פתיחת תחנה ועדכון בכל חוסר.",
    correctFb: "מוגדרים דיווח, נקודת בקרה ותנאי לעדכון.",
    d1: "בקרה ועדכון: להניח שהציוד הובא.",
    d1tag: "חסרה בקרה",
    d1fb: "הנחה אינה בקרה; נדרש דיווח מוכנות.",
    d2: "בקרה ועדכון: לבדוק בסוף היום.",
    d2tag: "מאוחר מדי",
    d2fb: "הבקרה צריכה לאפשר תגובה לפני הפתיחה.",
  },
};

// Row 1 occupies orders 1–11; rows 2 and 3 continue from there.
const riskExtraRows: DocumentSection[] = [
  ...buildRiskRow("r2", 12, "monitoring", riskRow2Data),
  ...buildRiskRow("r3", 23, "r2-monitoring", riskRow3Data),
];
...
const paka: ModuleContent = {
  ...
  builderContext: {
    eyebrow: "חובה לקרוא לפני המילוי",
    title: "מידע נוסף לקריאה",
    description:
      "הפסקאות הבאות הן הרקע המינימלי להבנת הסיפור. הן לא כתובות כמו תשובות לטופס, אבל בלעדיהן קשה לבחור נכון בין האפשרויות.",
    paragraphs: [
      "הפעילות שעליה נבנית הפק״א היא יום אימון צוותי במתחם ההכשרות בתאריך 15.7. היום מתוכנן להימשך משלב ההתייצבות בבוקר ועד סיום ופיזור אחר הצהריים, במסגרת זמן של 07:30–15:30. משתתפים בו 24 צוערים, והם אמורים לפעול בשלושה צוותים.",
      "הרעיון של היום הוא לא רק להעביר את הצוערים בין תחנות, אלא לתרגל עבודה צוותית בתוך מסגרת זמן, תוך חלוקת אחריות ברורה ושליטה של מפקד הפעילות. הפעילות מתבצעת כסבב בין שלוש תחנות, ולכן חשוב להבין שיש משמעות לפתיחת תחנות בזמן, לתדריך, למעברים, להפסקה ולסיכום.",
      "כדי שהיום יעבוד בפועל צריך שיהיו בעלי תפקידים שאפשר לבקר מולם ביצוע. יש צורך בתיאום הסעות, במוכנות ציוד בכל מעבר תחנה, ובדיווח מוקדם למפקד הפעילות אם משהו לא מוכן. בהקשר הזה אחראי הלוגיסטיקה הוא הגורם שאמור לוודא הימצאות ותקינות ציוד לפני פתיחת היום, כך שלמפקד תהיה תמונת מוכנות עוד לפני שהפעילות מתחילה.",
      "ברקע קיימים גם תנאי חום, שימוש בציוד הדרכה ותנועה ברכבים. לכן לאורך הפק״א צריך לשים לב לנקודות שמאפשרות שליטה ובטיחות: שתייה ומעקב חום, דיווח על שינוי בתנאים, ועצירת פעילות במקרה של תקלה בציוד או ברכב עד לקבלת אישור מהמפקד.",
    ],
  },
  documentSections: [
    section({
    ...
    section({
      ...
      options: [
        option(
          ...
          "לו״ז עקרוני: 07:30 התייצבות ובדיקת נוכחות; 07:45 תדריך פתיחה ובטיחות; 08:00 פתיחת תחנה א׳; 09:30 מעבר לתחנה ב׳; 11:00 מעבר לתחנה ג׳; 12:30 הפסקת צהריים; 13:15 המשך סבב תחנות; 15:00 סיכום ומשוב; 15:30 סיום ופיזור.",
          "נכון",
...
const risk: ModuleContent = {
  ...
  builderContext: {
    ...
    title: "מידע נוסף לקריאה",
    description:
      "הפסקאות הבאות נותנות את הרקע המינימלי לסיכון שעליו מתרגלים. הן מתארות את המצב, לא מחלקות אותו מראש לשדות הטבלה.",
    paragraphs: [
      "ביום האימון יש תנועה בשני רכבים כחלק מההגעה וההתארגנות לפני פתיחת התחנות. אחד מרכבי התובלה עדיין לא קיבל אישור כשירות סופי לפני היציאה. המשמעות היא שהבעיה נמצאת בשלב ההכנה והתנועה, עוד לפני שהפעילות בתחנות מתחילה.",
      "בתמונה הרחבה קיימים גם חום, ציר תנועה חשוף, לוחות זמנים צפופים וצורך בדיווחים למפקד הפעילות. כל אלה חשובים, אבל בסיפור הספציפי שמנתחים כאן מקור הבעיה הוא האמצעי עצמו: רכב שאמורים להשתמש בו, אך כשירותו עדיין לא אושרה.",
      "אם הרכב ייצא בלי שהכשירות שלו נבדקה ואושרה, עלולה להתרחש תקלה במהלך התנועה. תקלה כזו יכולה לעכב את פתיחת היום, לשבש את רצף התחנות, ובמצב חמור יותר לפגוע בבטיחות המשתתפים. אין נתון שמוכיח שהתקלה ודאית, אבל עצם היעדר האישור יוצר אי־ודאות ממשית.",
      "המענה הנדרש צריך לשנות את מצב הסיכון ולא להסתפק באמירה כללית של זהירות. לפני יציאה צריך להשלים בדיקת כשירות, לקבל אישור של מפקד הפעילות ולהחזיק אפשרות לרכב חלופי אם הרכב לא יאושר. נדרש גם גורם אחד שניתן לבקר מולו את הבדיקה ואת הדיווח לפני היציאה.",
      "גם אחרי מענה טוב הסיכון לא נעלם לגמרי: תקלה ברכב עדיין יכולה להיות משמעותית אם תתרחש, אבל בדיקה, אישור וחלופה אמורים להקטין מאוד את הסיכוי לכך. לכן חשוב להמשיך לעדכן את הערכת הסיכון אם משתנים תנאי הרכב, מזג האוויר או תמונת המוכנות.",
    ],
  },
  documentSections: [
    section({
...
const debrief: ModuleContent = {
  ...
  builderContext: {
    ...
    title: "מידע נוסף לקריאה",
    description:
      "הפסקאות הבאות הן חומר הגלם להבנת האירוע. הן לא מסודרות כמו דוח תחקיר, כדי שתצטרכו להבחין בעצמכם בין עובדה, פער, גורם ולקח.",
    paragraphs: [
      "התחקיר עוסק באירוע מתוך יום האימון הצוותי במתחם ההכשרות בתאריך 15.7. במהלך היום תחנה ב׳ הייתה אמורה להיפתח בשעה 10:00, אך בפועל נפתחה בשעה 10:15. לא היו נפגעים והפעילות הושלמה, אבל נוצר עיכוב שפגע ברצף המתוכנן של הסבב.",
      "ביום האימון היו שלוש תחנות בסבב מתוזמן, עם לו״ז פתיחה מאושר וצורך באחראי לכל תחנה. בעת מעבר הצוותים לתחנה ב׳ התברר שחסר פריט ציוד שנדרש להפעלת התחנה. בהמשך נמצא שהפריט היה במחסן, אך לא הועבר לתחנה לפני מועד הפתיחה.",
      "לצורך התחקיר רלוונטיים מפקד הפעילות, אחראי הלוגיסטיקה ואחראי תחנה ב׳. המידע שנאסף מהם מצביע על כך שלא היה בעל תפקיד אחד שהוגדר מראש לוודא את מוכנות ציוד התחנות לפני הפתיחה, וגם לא בוצעה בדיקת מוכנות מסודרת מספיק מוקדם כדי למנוע את העיכוב.",
      "בתחקיר חשוב לא להפוך את העובדות להאשמות. העובדה היא שהתחנה נפתחה באיחור ושפריט ציוד לא הועבר בזמן; ההסבר המקצועי צריך להיגזר מהפער בתכנון האחריות ובבקרה. לצד התקלה, יש גם נקודה לשימור: החוסר זוהה ודווח למפקד הפעילות, והפעילות חודשה בתוך זמן קצר יחסית.",
      "הלמידה להמשך צריכה להיות פעולה מקומית וישימה שמונעת חזרה של אותו פער, למשל קביעה מראש של אחריות, זמן בדיקה ודיווח לפני פתיחת התחנות. אם עולה צורך בשינוי נוהל רחב יותר שאינו בסמכות המתחקר המקומי, הוא צריך לעבור כהמלצה לגורם בעל הסמכות ולא כהוראה מקומית.",
    ],
  },
  documentSections: [
    section({
