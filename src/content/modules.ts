  ...
  documentSections: [
    section({
      ...
      options: [
        option(
          ...
          "ביום 15.7 יתקיים יום אימון צוותי במתחם ההכשרות, בהשתתפות 24 צוערים בשלושה צוותים. הפעילות תתקיים בין 07:30 ל־15:30.",
          "נכון",
    ...
    section({
      ...
      options: [
        option(
          "paka-goals-correct",
          "לתרגל עבודה בצוות, עמידה בלוחות זמנים והפעלת תחנות באופן מסודר.",
          "נכון",
    ...
    section({
      ...
      options: [
        option(
          ...
          "הפעילות נועדה לחבר בין תכנון, חלוקת אחריות וביצוע בפועל במסגרת זמן מוגדרת.",
          "נכון",
    ...
    section({
      ...
      options: [
        option(
          "paka-method-correct",
          "המשתתפים יחולקו לשלושה צוותים שינועו בסבב בין התחנות. לכל תחנה יוגדר אחראי ותתקיים החלפה מתוזמנת.",
          "נכון",
    ...
    section({
      ...
      options: [
        option(
          ...
          "07:30 התכנסות; 07:45 תדריך; 08:00 פתיחת תחנות; 12:00 הפסקה; 15:00 סיכום; 15:30 סיום.",
          "נכון",
    ...
    section({
      ...
      options: [
        option(
          ...
          "אחראי הלוגיסטיקה יוודא עד 07:15 שהציוד לכל תחנה קיים ותקין.",
          "נכון",
    ...
    section({
      ...
      options: [
        option(
          ...
          "יש להקפיד על שתייה, דיווח על שינוי בתנאים ועדכון מיידי במקרה של תקלה בציוד או ברכב.",
          "נכון",
      ...
      documentBlocks: [
        {
          ...
          label: "כללי",
          content:
            "ביום 15.7 יתקיים יום אימון צוותי בהשתתפות 24 צוערים בשלושה צוותים, בין 07:30 ל־15:30.",
        ...
        },
        {
          ...
          label: "מטרות",
          content:
            "הצוערים יתחלקו לשלושה צוותים ויעברו בין שלוש התחנות.",
        ...
        },
        {
          ...
          sectionId: "rationale",
          label: "רציונל",
          content: "נדרש לקיים יום אימון צוותי משום שזהו יום אימון צוותי.",
        ...
        },
        {
          ...
          label: "שיטה",
          content:
            "הצוערים יחולקו לשלושה צוותים. בכל תחנה יתקיים תרגיל בן 45 דקות.",
          expectedAnnotations: ["paka-missing"],
          explanation:
        ...
        },
        {
          ...
          label: "ארגון התחנות",
          content:
            "לכל תחנה יוגדר אחראי שיקבל את הצוות, יתדרך ויאשר את סיום הביצוע.",
          expectedAnnotations: [],
          explanation:
        ...
        },
        {
          ...
          label: "לו״ז עקרוני",
          content:
            "07:30 פתיחת התחנות; 07:45 תדריך; 12:00 הפסקה; 15:30 סיום.",
        ...
        },
        {
          ...
          label: "תחומי אחריות",
          content: "יש לוודא שהציוד לכל תחנה קיים ותקין לפני הפעילות.",
        ...
        },
        {
          ...
          label: "דגשים",
          content:
            "ההתכנסות ב־07:30, התדריך ב־07:45, ההפסקה ב־12:00 והסיום ב־15:30.",
        ...
        },
        {
          ...
          label: "דגש מזג אוויר",
          content:
            "בשל עומס החום יש להקפיד על שתייה ולדווח מיד על שינוי במצב משתתף.",
          expectedAnnotations: [],
          explanation:
  ...
  documentSections: [
    section({
      ...
      options: [
        option(
          "risk-m5-machine",
          "Machine — ציוד ואמצעים: אחד מכלי הרכב טרם עבר בדיקת כשירות סופית.",
          "נכון",
        ...
        option(
          "risk-m5-medium",
          "Medium — סביבה: אחד מכלי הרכב טרם עבר בדיקת כשירות סופית.",
          "תחום לא מתאים",
          "",
        ...
        option(
          "risk-m5-management",
          "Management — פיקוד ושליטה: אחד מכלי הרכב טרם עבר בדיקת כשירות סופית.",
          "תחום לא מתאים",
          "",
    ...
    section({
      ...
      options: [
        option(
          ...
          "בגלל אי־בדיקת כשירות הרכב עלולה להתרחש תקלה במהלך התנועה ולגרום לעיכוב או לפגיעה.",
          "נכון",
    ...
    section({
      ...
      options: [
        option(
          ...
          "לבצע בדיקת כשירות מלאה לפני היציאה ולהחזיק חלופת רכב זמינה.",
          "נכון",
    ...
    section({
      ...
      options: [
        option(
          "risk-owner-correct",
          "אחראי הרכב ישלים בדיקה עד 07:00 ויעדכן את מפקד הפעילות.",
          "נכון",
    ...
    section({
      ...
      options: [
        option(
          ...
          "מפקד הפעילות יקבל עדכון כשירות עד 07:00, יוודא חלופה, ויעדכן את ההערכה אם חל שינוי ברכב או בתנאים.",
          "נכון",
      ...
      documentBlocks: [
        {
          ...
          content:
            "סיכון: מזג אוויר. חומרה 3, סבירות 3, רמה ראשונית 9.",
          expectedAnnotations: [
        ...
        },
        {
          ...
          label: "Man — רכב",
          content:
            "תחום M5: Man. סכנה: רכב שלא עבר בדיקת כשירות.",
        ...
        },
        {
          ...
          content:
            "חומרה 4, סבירות 3, רמת סיכון ראשונית: 4 — נמוך.",
        ...
        },
        {
          ...
          label: "פעילות מתקנת",
          content:
            "בגלל רכב שלא נבדק עלולה להתרחש תקלה. פעילות מתקנת: להזכיר לכולם להיות זהירים.",
        ...
        },
        {
          ...
          label: "אחראי ומועד",
          content:
            "כולם אחראים לבצע את בדיקת הרכב מתישהו לפני היציאה.",
        ...
        },
        {
          ...
          content:
            "בוצעה בדיקת כשירות ונקבע רכב חלופי. רמת הסיכון הראשונית: 12.",
        ...
        },
        {
          ...
          label: "בקרה",
          content:
            "אחראי הרכב הונחה להשלים בדיקה עד 07:00. לא נדרש דיווח נוסף.",
        ...
        },
        {
          ...
          content:
            "בגלל עומס חום משתתף עלול להיפגע. הפעילות תוקדם, יוגדרו הפסקות שתייה ואחראי צוות יבצע בקרה בכל מעבר.",
          expectedAnnotations: [],
          explanation:
        ...
        },
        {
          ...
          content:
            "אחראי הרכב ישלים בדיקה עד 07:00, ידווח למפקד הפעילות ויוודא חלופה זמינה. לאחר המענה: חומרה 4, סבירות 1, רמה 4.",
          expectedAnnotations: [],
          explanation:
  ...
  documentSections: [
    section({
      ...
      options: [
        option(
          ...
          "ביום 15.7 התקיים יום אימון צוותי במתחם ההכשרות בהשתתפות 24 צוערים. התחקיר מתמקד בעיכוב בתחנה השנייה ובחוסר בציוד.",
          "נכון",
    ...
    section({
      ...
      options: [
        option(
          ...
          "התחנה השנייה תוכננה להיפתח בשעה 10:00 ונפתחה בפועל בשעה 10:15. בעת המעבר התברר שחסר פריט ציוד אחד.",
          "נכון",
    ...
    section({
      ...
      options: [
        option(
          "debrief-gap-correct",
          "פתיחת התחנה השנייה התעכבה ב־15 דקות ביחס ללו״ז.",
          "נכון",
    ...
    section({
      ...
      options: [
        option(
          ...
          "בדיקת הציוד לא שובצה לאחריות של בעל תפקיד ולכן החוסר התגלה רק בזמן המעבר.",
          "נכון",
    ...
    section({
      ...
      options: [
        option(
          ...
          "בכל פעילות יוגדר בפק״א בעל תפקיד שיבדוק את ציוד התחנות עד 30 דקות לפני תחילתן וידווח על השלמה.",
          "נכון",
    ...
    section({
      ...
      options: [
        option(
          ...
          "הפער המרכזי נבע מאחריות לא מוגדרת לבדיקת הציוד. הלקח המרכזי הוא שילוב הבדיקה בפק״א עם אחראי ומועד.",
          "נכון",
      ...
      documentBlocks: [
        {
          ...
          label: "כללי",
          content:
            "ביום 15.7 התקיים יום אימון צוותי במתחם ההכשרות. התחקיר מתמקד בעיכוב בתחנה השנייה ובחוסר בציוד.",
          expectedAnnotations: [],
          explanation:
        ...
        },
        {
          ...
          label: "ממצא 1",
          content:
            "אחראי התחנה היה לא מקצועי ולא התייחס ברצינות למשימה.",
          expectedAnnotations: [
        ...
        },
        {
          ...
          sectionId: "findings",
          label: "ממצא 2",
          content: "בשלב כלשהו התחנה השנייה נפתחה באיחור.",
        ...
        },
        {
          ...
          label: "תקלה / פער",
          content:
            "התחנה התעכבה משום שאחראי הציוד לא ביצע בדיקה מוקדמת.",
        ...
        },
        {
          ...
          label: "מסקנה",
          content:
            "העיכוב נגרם משום שהצוערים לא הכירו את מתחם ההכשרות.",
        ...
        },
        {
          ...
          sectionId: "lessons",
          label: "לקח 1",
          content: "בפעילות הבאה צריך להיות מסודרים יותר ולא לאחר.",
        ...
        },
        {
          ...
          sectionId: "lessons",
          label: "לקח 2",
          content: "יש לבדוק את כל הציוד לפני פתיחת התחנות.",
        ...
        },
        {
          ...
          label: "סיכום",
          content:
            "הפער המרכזי היה עיכוב בתחנה. בנוסף, אחד המשתתפים נפצע במהלך היום.",
