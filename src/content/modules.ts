...
const paka: ModuleContent = {
  ...
  builderContext: {
    ...
    outcome:
      "קראו את המידע הזה לפני בחירת תשובה. הוא אמור לתת לכם את תמונת הפעילות, אבל עדיין תצטרכו לזהות לבד איזה ניסוח מתאים לכל חלק בטופס.",
  },
  documentSections: [
    section({
      id: "general",
...
const risk: ModuleContent = {
  ...
  builderContext: {
    ...
    outcome:
      "קראו את המידע הזה לפני בחירת תשובה. הוא נותן את חומר הגלם להבנת הסיכון, אבל את הסיווג, הניסוח וההערכה תצטרכו לבצע בעצמכם.",
  },
  documentSections: [
    section({
      id: "stage",
...
const debrief: ModuleContent = {
  ...
  builderContext: {
    ...
    outcome:
      "קראו את המידע הזה לפני בחירת תשובה. הוא מספר את האירוע, אבל עדיין תצטרכו להחליט מה שייך לממצא, מה לגורם, מה ללקח ומה להמלצה.",
  },
  documentSections: [
    section({
      id: "event-date",
